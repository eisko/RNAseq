...
gois <- c("Nnmt", "Nampt", "Nmnat1", "Nmnat2", "Nmnat3", "Nmrk1", "Nmrk2", "Sirt1", "Cd38", "Pparg", "Mat1a", "Mat2a", "Mat2b", "Amd1", "Gnmt", "Gamt", "Pemt", "Mtr", "Mtrr", "Bhmt", "Ahcy", "Cbs", "Aox1", "Aox2", "Cyp2e1")
...
labeled_gois_FPKM$group <- recode(labeled_gois_FPKM$group, Un_Sham = "Unaffecteds (+/-)\nNo Treatment\n(n=6)", Un_Vanc = "Unaffecteds (+/-)\nVancomycin\n(n=6)", Af_Sh = "Affecteds (-/-)\nNo Treatment\n(n=6)", Af_Vanc = "Affecteds (-/-)\nVancomycin\n(n=6)")
